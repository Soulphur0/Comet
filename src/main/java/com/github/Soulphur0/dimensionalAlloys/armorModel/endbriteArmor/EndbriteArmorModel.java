...
package com.github.Soulphur0.dimensionalAlloys.armorModel.endbriteArmor;
...
public class EndbriteArmorModel<T extends LivingEntity> extends BipedEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        .uv(10, 57).cuboid(-3.99F, -10.0F, -3.99F, 7.98F, 1.0F, 1.0F, new Dilation(1.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
